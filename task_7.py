...
def space(string):
    ...
    while dc_.size() > 1 and still_equal:
        first = dc_.remove_from_front()
        last = dc_.remove_from_rear()
        if first != last:
            still_equal = False
...
print(space("молоко делили ледоколом"))
print(space("топот"))
print(space("а роза упала на лапу азора"))
print(space("полиндром"))